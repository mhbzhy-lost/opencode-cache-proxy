...
const ANTHROPIC_OPUS_CONTEXT_MODELS = {
  ...
  "claude-opus-4-8-1m": { name: "Claude Opus 4.8 (1M)", context: 1000000 },
}

// Effort variants are auto-generated by OpenCode's ProviderTransform.variants()
// when reasoning: true is set on the model. Opus 4.6 gets 4 tiers (low/medium/high/max),
// Opus 4.7+ gets 5 tiers (+ xhigh). No need to maintain manually.
...
const QWEN_OPEN_CODE_MODELS = {
  "qwen3.7-max": { name: "Qwen 3.7 Max", temperature: true },
  "qwen3.7-max-300k": { name: "Qwen 3.7 Max (300k)", temperature: true, limit: { context: 300000, output: 32768 } },
  "qwen3.7-max-512k": { name: "Qwen 3.7 Max (512k)", temperature: true, limit: { context: 512000, output: 65536 } },
  "qwen3.7-plus": { name: "Qwen 3.7 Plus", temperature: true },
  "qwen3.7-plus-nothink": { name: "Qwen 3.7 Plus (no thinking)", temperature: true },
}
